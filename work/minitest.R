...
triplet <- distances |> as_tibble(rownames = "fromidINS") |> pivot_longer(cols = -fromidINS, names_to = "toidINS", values_to = "distance") |> filter(!is.na(distance))

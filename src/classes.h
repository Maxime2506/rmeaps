...
public:
    ...
    const std::vector<unsigned long> p; // outerstarts (convention RSM).
    ...
    Urban(const std::vector<unsigned int> jr_, const std::vector<unsigned long> p_, const std::vector<double> xr_, 

...
//' La fonction meaps_continu qui ne renvoit que le KL de l'estimation en référence à une distribution connue. 
 ...
 // [[Rcpp::export]]
 NumericMatrix multishuf_optim_cpp(
...
#pragma omp parallel for num_threads(ntr) \
     shared(Nboot, N, ishuf, emploisinitial, fcpp, actifscpp, _xr_dist, _jr_dist, _p_dist, xr_lor, _row_group, _col_group) reduction(vsum : liaisons)
#endif
